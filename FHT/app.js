(function(){
  ...
  var colorCalibration = [ '#f6faaa','#FEE08B', '#f6ccaa','#ff9896','#FEA98B','#FDAE61','#F46D43','#D53E4F', '#d62728','#9E0142'];
  //var horizontalCalibration = ['#f6faaa','#FEE08B','#FDAE61','#F46D43','#D53E4F','#9E0142'].reverse().concat(colorCalibration);
  var horizontalCalibration = colorCalibration;

  //axises and scales
  var axisWidth = itemSize*256;
  var axisHeight = itemSize*64;
  ...
  .append("text")
    ...
    .attr("dx", String(anonWidth/2))
    .attr("dy", "5em")
    .text("Heading Bytes Correlation Strength");
